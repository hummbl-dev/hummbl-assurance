...
3. uploads verifier artifacts (`verify_run1.txt`, `verify_run2.txt`, `verify_diff.txt`, `vendor_surface_evidence.json`, `SHA256SUMS.txt`) to the matching GitHub Release
